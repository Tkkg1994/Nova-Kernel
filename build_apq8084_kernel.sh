...
BUILD_CROSS_COMPILE=/Kernel_Folder/Toolchain_4.9.4-2015.06_a15/bin/arm-cortex_a15-linux-gnueabihf-
...
FUNC_BUILD_KERNEL()
{
	...
	make -C $BUILD_KERNEL_DIR O=$BUILD_KERNEL_OUT_DIR -j$BUILD_JOB_NUMBER ARCH=arm \
			...
			SELINUX_LOG_DEFCONFIG=$SELINUX_LOG_DEFCONFIG \
			TIMA_DEFCONFIG=$TIMA_DEFCONFIG DMVERITY_DEFCONFIG=$DMVERITY_DEFCONFIG || exit -1
