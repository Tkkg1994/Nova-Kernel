...
PRODUCT_OUT=$BUILD_ROOT_DIR/Nova_out

BUILD_CROSS_COMPILE=/Kernel_Folder/Toolchain_5.2_a15/bin/arm-cortex_a15-linux-gnueabihf-
...
NOVA_ADD_DEFCONFIG=0Nova-Kernel_SM-G901F_defconfig
...
FUNC_BUILD_KERNEL()
{
	...
	make -C $BUILD_KERNEL_DIR O=$BUILD_KERNEL_OUT_DIR -j$BUILD_JOB_NUMBER ARCH=arm \
			...
			DEBUG_DEFCONFIG=$NOVA_ADD_DEFCONFIG SELINUX_DEFCONFIG=$SELINUX_DEFCONFIG \
